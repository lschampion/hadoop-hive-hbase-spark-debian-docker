...
#  | gunzip \
#  | tar -x -C /usr/ \
RUN tar -xf "hadoop-${HADOOP_VERSION}.tar.gz" -C /usr/ \
...
#    | gunzip \
#    | tar -x -C /usr/ \
RUN tar -xf "apache-hive-${HIVE_VERSION}-bin.tar" -C /usr/ \
...
#    | gunzip \
#    | tar -x -C /usr/ \
RUN tar -xf "hbase-${HBASE_VERSION}-bin.tar.gz" -C /usr/ \
...
#  | gunzip \
#  | tar x -C /usr/ \
RUN tar -xf "spark-${SPARK_VERSION}-bin-without-hadoop.tgz" -C /usr/ \
...
#  | gunzip \
#  | tar x -C /usr/ \
RUN tar -xf "apache-zookeeper-${ZK_VERSION}-bin.tar.gz" -C /usr/ \
